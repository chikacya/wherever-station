...
- Same-VPS subscriptions can display Agent usage against the VPS traffic-monitoring allowance and accounting direction; an explicitly enabled custom allowance uses combined upload and download without gating availability.
