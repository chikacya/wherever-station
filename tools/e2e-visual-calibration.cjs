...
async function main() {
  ...
  const managedInstances = [
    { id: 'managed-nowhere', kind: 'nowhere', name: '日本 · Nowhere', machineId: 'server-jp', nodeId: nodes[0].id, publicHost: '203.0.113.10', port: 2078, tcpPort: 2078, udpPort: 2078, version: 'v2.0.2', network: 'mix', listenHost: '0.0.0.0', status: 'running', updatedAt: '2026-09-12T10:00:00Z', certificateId: 'cert-visual000000001', certificateMode: 'managed' },
  ...
  const instanceStates = [
    { instanceId: 'managed-nowhere', machineId: 'server-jp', state: 'active', pid: 2314, observedAt: new Date().toISOString(), telemetry: { source: 'local', lifecycle: 'READY', version: '2.0.2', upBytesPerSecond: 18432, downBytesPerSecond: 32768, cpuPercent: 1.2, rssBytes: 52 * 1024 ** 2 } },
